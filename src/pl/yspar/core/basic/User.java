...
public class User extends MySQLEntry {
    ...
    public User(final String p, final String x) {
        this.name = p;
        this.kolor = "";
        this.team = "";
        this.points = 1000;
    ...
    public static void save(Player p) throws IOException {
        ...
        c.save(new File("plugins/core/data/" + p.getName()+".yml"));
    }
    ...
    public ParticleType getParticleType() {
	  ...
	  public void setlastPosition(Location lastPosition)
	  {
		...
		public String getSQL() {
			...
			(sb = new StringBuilder()).append("INSERT INTO `pCore_USERS` VALUES(");
			sb.append("'%name%',");
			sb.append("%points%,");
			sb.append("%guild%,");
			sb.append("%kills%,");
	...
	public void removeTpaRequest(final String name) {
		this.tpaRequest = "";
	}
    ...
    public String getKrety() {
        return this.krety;
    }
    
    public void setKrety(final String krety) {
        this.krety = krety;
    }
    ...
    public void setKolor(final String kolor) {
        this.kolor = kolor;
    }
